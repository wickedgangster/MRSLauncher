...
window.eval = global.eval = function () {
    throw new Error('이 프로그램은 window.eval()을 지원하지 않습니다.')
}
        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/peunsu/MRSLauncher/releases/download/v${info.version}/MRS-Launcher-setup-${info.version}.exe`
                    showUpdateUI(info)
                }
            ...
            case 'update-downloaded':
                loggerAutoUpdaterSuccess.log(info.version + ' 업데이트를 설치할 준비가 되었습니다.')
